  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="relative overflow-hidden">
        ...
        {/* Prospectus Request Form Modal */}
        {showForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-md shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in duration-300">
              {/* Header */}
              <div className="bg-primary px-6 py-4 text-white relative">
                <h3 className="text-2xl font-bold">Request a Prospectus</h3>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-white text-lg py-3 font-semibold"
                >
                  Send Request
                </Button>
              </form>
