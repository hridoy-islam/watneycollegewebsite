      ...
      <section className="container mx-auto px-4 py-12 max-w-4xl text-gray-800 space-y-8">
        ...
        <article>
          ...
          <p>
            ...
            and course materials, is the property of Watney College or its
        ...
        <article>
          ...
          <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <li>
              Attempt to gain unauthorized access to the Site, the server on
        ...
        <article>
          <h2 className="text-2xl font-semibold mb-3">
            4. Course Enrolment and Payments
          </h2>
          <p>
            ...
            paid in full prior to the commencement of the course unless
            otherwise agreed. All payments are subject to our refund policy.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            accuracy. The College will not be liable for any direct, indirect,
            or consequential loss or damage arising under or in connection with
            the use of the Site.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            The Site may contain links to external websites. Watney College is
            not responsible for the content or reliability of any external
            websites linked to from the Site and does not endorse the views
        ...
        <article>
          ...
          <p>
            Watney College reserves the right to amend these Terms and
            Conditions at any time. Changes will be posted on this page, and
            your continued use of the Site constitutes acceptance of the amended
            terms.
          </p>
        </article>
