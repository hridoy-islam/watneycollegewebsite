...
const HLine = ({ w = "w-full" }: { w?: string }) => (
  <div className={`relative mx-auto ${w} h-6 z-0 pointer-events-none`}>
    {/* Solid Line */}
        ...
        <div className=" overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-watney/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  ...
                  <div className="relative inline-flex items-start gap-4 sm:gap-6 lg:gap-10 z-10 mt-[-3px]">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="relative inline-flex items-start gap-4 sm:gap-6 mt-[-3px]">
                        {/* Exact Horizontal Spine 2 with dashed line */}
                        <div className="absolute top-0 left-[70px] right-[70px] sm:left-[80px] sm:right-[80px] z-0 pointer-events-none">
                          <div className="absolute top-0 w-full h-[3px] bg-watney" />
                          <div className="absolute top-[8px] left-[7px] w-full border-t-[3.5px] border-dashed border-watney">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="relative inline-flex items-start gap-4 sm:gap-6 mt-[-3px]">
                        {/* Exact Horizontal Spine 3 with dashed line */}
                        <div className="absolute top-0 left-[70px] right-[70px] sm:left-[80px] sm:right-[80px] z-0 pointer-events-none">
                          <div className="absolute top-0 w-full h-[3px] bg-watney" />
                          <div className="absolute top-[8px] left-[7px] w-full border-t-[3.5px] border-dashed border-watney">
                            {/* <div className="absolute -left-[4px] -top-[6px] text-[10px] text-watney leading-none">◀</div>
          ...
          <section className="relative py-24 overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
              ...
              <div className="mx-auto bg-white/90 rounded-3xl shadow-xl overflow-hidden border border-blue-100 flex flex-col md:flex-row">
                  ...
                  <div className="relative z-10">
                    ...
                    <ul className="space-y-6">
                      {[
                        ...
                        >
                          <CheckCircle2 className="w-6 h-6 text-watney shrink-0 group-hover:scale-110 transition-transform" />
                          {item}
                        </motion.li>
                      ))}
                    </ul>
                ...
                {/* Divider */}
                <div className="hidden md:block w-1 bg-gradient-to-b from-watney via-watney to-watney z-10 relative"></div>
          ...
          <section className="relative py-20 overflow-hidden">
            ...
            <div className="container mx-auto relative z-10">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-watney/5 to-transparent rounded-3xl pointer-events-none z-0" />
                <div className="relative z-10">
