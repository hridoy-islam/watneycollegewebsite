    ...
    <>
      ...
      <TabsContent value="overview" className="space-y-6">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-2 text-black mb-4">
      ...
      <TabsContent value="curriculum" className="space-y-6">
        <div>
          ...
          <ul className="space-y-2 text-black mb-8">
            <li className="flex items-start space-x-2">
              <span className="text-primary font-bold">•</span>
        ...
        <div>
          ...
          <ul className="space-y-3 mb-8">
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Core Language Skills:</span>
              <span className="text-black">Integrated development of speaking, listening, reading, and writing</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Language Systems:</span>
              <span className="text-black">Focus on grammar, vocabulary, and pronunciation to improve accuracy and range</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Functional Communication:</span>
              <span className="text-black">Practical use of English for everyday situations, workplace communication, and problem-solving</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Skills Development:</span>
              <span className="text-black">Activities designed to build fluency, confidence, and interaction skills, including discussions, role plays, and presentations</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Reading and Listening Practice:</span>
              <span className="text-black">Exposure to authentic and semi-authentic materials to develop comprehension and critical understanding</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Writing Development:</span>
              <span className="text-black">Structured tasks ranging from emails and reports to essays and formal writing (progressively more advanced at B2–C1)</span>
            </li>
            <li className="bg-gray-50 p-4 rounded-lg">
              <span className="font-semibold text-black block mb-1">Independent Learning:</span>
              <span className="text-black">Guided self-study, homework, and use of digital resources to reinforce classroom learning</span>
            </li>
          </ul>
